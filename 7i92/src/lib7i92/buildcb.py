def build(parent):
	...
	build_sscards(parent)

def build_sscards(parent):
	smartSerialCardList = [
	['Select', False],
	['7i64','7i64'],
	['7i69','7i69'],
	...
	for item in smartSerialCardList:
		parent.smartSerialCardCB.addItem(item[0], item[1])
...
def build_firmware(parent):
	...
	parent.guiCB.addItem('Axis', 'axis')
	parent.guiCB.addItem('Touchy', 'touchy')

	parent.toolChangerTypeCB.addItem('Manual', 'manual')
	parent.toolChangerTypeCB.addItem('Non-Random', 'non-random')
	parent.toolChangerTypeCB.addItem('Random', 'random')

	parent.toolChangerFeedbackCB.addItem('None', False)
	parent.toolChangerFeedbackCB.addItem('Tool Changed', 'tool-changed')
	parent.toolChangerFeedbackCB.addItem('', '')
