...
import m7i92.buildcombos as buildcombos
import m7i92.loadini as loadini
import m7i92.checkit as checkit
import m7i92.buildfiles as buildfiles
import m7i92.card as card
import m7i92.helptext as helptext
from m7i92.dialog import Ui_Dialog as errorDialog
from m7i92.help import Ui_Dialog as helpDialog
...
class MainWindow(QMainWindow):
	def __init__(self):
		...
		self.cwd = os.getcwd()
		self.setWindowTitle('7i92 Configuration Tool Version {}'.format(VERSION))
	...
	def setupConnections(self):
		...
		self.daugtherBoardCB.currentIndexChanged.connect(self.daughterChanged)
		for i in range(5):
	...
	def daughterChanged(self):
		print(self.daugtherBoardCB.itemData(self.daugtherBoardCB.currentIndex()))
		if self.daugtherBoardCB.itemData(self.daugtherBoardCB.currentIndex()) == '7i76':
			self.jointsStkWidget.setCurrentIndex(0)
		elif self.daugtherBoardCB.itemData(self.daugtherBoardCB.currentIndex()) == '7i77':
			self.jointsStkWidget.setCurrentIndex(1)
	...
	def buildCB(self):
		...
		for item in buildcombos.setupCombo('daugtherBoardCB'):
			self.daugtherBoardCB.addItem(item[0], item[1])
