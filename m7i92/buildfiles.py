...
def buildio(parent):
	...
	for index in range(15):
		...
		if outputText == 'Coolant Flood':
			ioContents.append('net flood-output iocontrol.0.coolant-flood => hm2_7i92.0.7i76.0.0.output-{0:02}\n'.format(index))
		if outputText == 'Coolant Mist':
			ioContents.append('net mist-output iocontrol.0.coolant-mist => hm2_7i92.0.7i76.0.0.output-0{0:02}\n'.format(index))
		if outputText == 'Spindle On':
			ioContents.append('net spindle-on motion.spindle-on => hm2_7i92.0.7i76.0.0.output-{0:02}\n'.format(index))
		if outputText == 'Spindle CW':
			ioContents.append('net spindle-cw motion.spindle-forward => hm2_7i92.0.7i76.0.0.output-{0:02}\n'.format(index))
		if outputText == 'Spindle CCW':
			ioContents.append('net spindle-ccw motion.spindle-reverse => hm2_7i92.0.7i76.0.0.output-{0:02}\n'.format(index))
		if outputText == 'Spindle Brake':
			ioContents.append('net spindle-brake motion.spindle-brake => hm2_7i92.0.7i76.0.0.output-{0:02}\n'.format(index))
		if outputText == 'E-Stop Out':
			ioContents.append('net estop-loop hm2_7i92.0.7i76.0.0.output-0{0:02}\n'.format(index))
		if outputText == 'Digital Out 0':
			ioContents.append('net digital-out-0 motion.digital-out-00 => hm2_7i92.0.7i76.0.0.output-{0:02}\n'.format(index))
		if outputText == 'Digital Out 1':
			ioContents.append('net digital-out-2 motion.digital-out-01 => hm2_7i92.0.7i76.0.0.output-0{0:02}\n'.format(index))
